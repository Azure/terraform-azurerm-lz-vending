...
# also be required with network security group created is added to this accelerator.
  ...
  virtual_network_subnet_route_table_available_resource_ids = { for rt_k, rt_v in module.routetable : element(split("/", rt_v.route_table.route_table_resource_id), -1) => rt_v.route_table.route_table_resource_id }
